...
class MikesBaseRepository implements BaseRepositoryInterface {
    ...
    public function paginateArrayResults(array $data, int $perPage = 50) {
        ...
        return new LengthAwarePaginator(
                array_slice($data, $offset, $perPage, true), count($data), $perPage, $page, [
    ...
    Model $model, TransformerAbstract $transformer, string $resourceKey, string $includes = null
    ): Scope {
    ...
    Collection $collection, TransformerAbstract $transformer, string $resourceKey, string $includes = null, $perPage = 25
    ): Scope {
        $manager = new ItemAndCollectionManager(new Manager);
