        ...
        <div class="col-md-12">
            <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" @if(request()->input('tab') == 'returns') class="active" @endif><a href="#returns" aria-controls="returns" role="tab" data-toggle="tab">Returns</a></li>
                </ul>
                ...
                <div class="tab-content customer-order-list">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn" style="color: #ffffff; background-color: {{ $order['status']->color }}">{{ $order['status']->name }}</button>
                                        <a href="{{ route('customer-returns.create', $order['id']) }}" class="btn btn-warning">Return</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div role="tabpanel" class="tab-pane @if(request()->input('tab') == 'returns')active @endif" id="returns">
                        @if(!$returns->isEmpty())
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            <a href="{{ route('customer-returns.edit', $return->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> View</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
