            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="col-md-4">
                            <label class="radio">
                                <input type="radio" name="rate" data-courier="{{$delivery_method->courier}}" data-fee="{{ number_format((float)$delivery_method->cost, 2, '.', '') }}" value="{{ number_format((float)$delivery_method->cost, 2, '.', '') }}">
                            </label>
                            {{ $couriers[$delivery_method->courier]->name }}  
                            <br>{{config('cart.currency')}} {{number_format((float)$delivery_method->cost, 2, '.', '')}}
                            <br> @if($delivery_method->is_priority === 1)<label class="label label-success">Priority</label> @endif
                        </li>
                        @endforeach
                    </ul>
                </div>
