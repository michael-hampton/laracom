...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview @if(request()->segment(2) == 'refunds') active @endif">
                <a href="#">
                    <i class="fa fa-anchor"></i> <span>Refunds</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.refunds.index') }}"><i class="fa fa-circle-o"></i> List Refunds</a></li>
                    <li><a href="{{ route('admin.refunds.create') }}"><i class="fa fa-plus"></i> Create Refund</a></li>
                </ul>
            </li>
            
            <li class="treeview @if(request()->segment(2) == 'vouchers') active @endif">
                <a href="#">
                    <i class="fa fa-anchor"></i> <span>Vouchers</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.vouchers.index') }}"><i class="fa fa-circle-o"></i> List Vouchers</a></li>
                    <li><a href="{{ route('admin.vouchers.create') }}"><i class="fa fa-plus"></i> Create Voucher</a></li>
                </ul>
            </li>
